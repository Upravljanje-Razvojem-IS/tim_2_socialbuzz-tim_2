...
{
    [ApiController]
    [Route("api/comment-type")]
    [Authorize]
    public class CommentTypeController : ControllerBase
    {
        private readonly ICommentReplyRepository _repository;

        public CommentTypeController(ICommentReplyRepository repository)
        {
        ...
        /// <returns>New comment reply</returns>
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [HttpPost]
        ...
        /// <param name="id"></param>
        /// <param name="dto"></param>
        /// <returns>Updated comment reply</returns>
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [HttpPut("{id}")]
